...
- aws-tableau- <group-name>@tableau.com - Naming Structure.
...
Get the ID for the account:```aws-acct-mgr account list ``` This will ID will be used in step 8 & 9.
...
8. aws-act-mgr terraform generate (code in atom)
...
- e is production. ""-prod" is production. "test is testing"
...
- If an error run terraform apply
